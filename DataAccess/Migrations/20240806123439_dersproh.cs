...
{
    /// <inheritdoc />
    public partial class dersproh : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LunchBreak = table.Column<bool>(type: "bit", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AcademicsID = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Timetables_Academics_AcademicsID",
                        column: x => x.AcademicsID,
                        principalTable: "Academics",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Timetables_ClassCourses_ClassCourseID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Timetables_AcademicsID",
                table: "Timetables",
                column: "AcademicsID");

            migrationBuilder.CreateIndex(
                name: "IX_Timetables_ClassCourseID",
                table: "Timetables",
